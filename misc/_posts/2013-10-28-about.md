...
We are big fans of open source software especially [Python](https://www.python.org/), [PyTorch](https://pytorch.org/), [Claude Code](https://claude.ai/code), [R](https://www.r-project.org/), [Bioconductor](https://www.bioconductor.org/), and [Posit](https://posit.co/)
