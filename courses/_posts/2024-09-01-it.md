...
Course Structure
The course will be run across both the Fall and Winter semester and will consist of 3 hours of lecture or
tutorial per week on average (26 weeks total). The course consists of a series of modules covering different
...
full day workshop). In the future, we will encourage other quantitative, computational biology and data
...
line.
Over the past year, this course has been run in an informal ad hoc manner. Over this time, we
completed an Introduction to Python (7 weeks), Introduction to R (6 weeks), the TidyVerse (3 weeks),
Introduction to GIT (1 week), Introduction to Modern File Servers and Security (1 week), Ethical Issues
with the use of ChatGPT and other large language models (1 week), PyTorch (3 weeks), and we are
currently working through the textbook Modern Statistics for Modern Biology (estimated 10 weeks).